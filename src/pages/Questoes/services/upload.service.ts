...
async function buscarAssinatura(): Promise<RespostaAssinatura> {
    const resposta = await httpClient.post<RespostaAssinatura>(
        "/cloudinary/signature-upload-questions-images"
    );
    return resposta.data;
}

/**
 * Faz upload de imagem para o Cloudinary usando assinatura do backend
 * @param arquivo - Arquivo de imagem para upload
